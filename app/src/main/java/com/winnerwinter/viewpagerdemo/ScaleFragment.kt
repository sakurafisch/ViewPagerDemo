...
import com.winnerwinter.viewpagerdemo.databinding.FragmentScaleBinding
...
class ScaleFragment : Fragment() {
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        binding.imageViewScale.setOnClickListener {
            ...
            ObjectAnimator.ofFloat(it, "scaleX", it.scaleX + factor)
                .start()
            ObjectAnimator.ofFloat(it, "scaleY", it.scaleY + factor)
                .start()
        }
